    ...
    <div v-if="$page.auth.user.owner" class="bg-white rounded shadow overflow-hidden max-w-lg">
      <form @submit.prevent="submit">
        <div class="p-8 -mr-6 -mb-8 flex flex-wrap">
          <text-input v-model="form.title" :errors="$page.errors.title" class="pr-6 pb-8 w-full lg:w-1/2" label="Cím" autofocus />
          <text-input v-model="form.body" :errors="$page.errors.body" class="pr-6 pb-8 w-full lg:w-1/2" label="Üzenet" />
