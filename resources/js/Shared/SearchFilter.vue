<template>
  <div class="flex items-center">
    <div class="flex w-full bg-white shadow rounded">
      <dropdown class="px-4 md:px-6 rounded-l border-r hover:bg-gray-300 focus:border-white focus:shadow-outline focus:z-10" placement="bottom-start">
        <div class="flex items-baseline">
          <span class="text-gray-800 hidden md:inline">Szűrés</span>
