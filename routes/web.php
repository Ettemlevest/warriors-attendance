...
Route::get('users/create', [UsersController::class, 'create'])->name('users.create')->middleware('auth', 'lowercase');
...
Route::put('users/{user}', [UsersController::class, 'update'])->name('users.update')->middleware('auth', 'lowercase');
...
Route::put('trainings/{training}/comment', [TrainingController::class, 'comment'])->name('trainings.comment')->middleware('auth');
